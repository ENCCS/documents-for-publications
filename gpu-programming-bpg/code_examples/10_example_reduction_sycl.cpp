// In this example, we use built-in sycl::reduction mechanism.
// The manual implementation of reduction kernel can be found in "Non-portable kernel models" chapter.
